# [🍇 포동포동 : 포도나무 감상 걸렸네](podong-podong.vercel.app)
...
- 🍇 포도 등록: 책을 검색해 등록하면 포도 하나가 농장에 등록됩니다. 하나씩 모아가며 포도농장을 키워보세요! 
- 📌 메인 포도 등록: 현재 읽고 있는 책을 포도농장의 메인 포도로 등록하세요. 
- ✨ 포도알 관리: 감상평을 등록하거나 농도를 지정하면 포도알이 채워집니다. 비어있는 포도알을 포동포동하게 만들어보세요.
- ✏️ 포도알 감상평 확인: 등록된 포도(책)의 감상평은 메인 포도의 포도알을 클릭해 확인 가능합니다. 
- 🌳 포도농장(서재) 방문: 포도농장을 방문하면 당신이 키운 포도들을 한 눈에 확인 할 수 있습니다. 어떤 포도들이 당신의 독서 농장을 장식하고 있나요?

포도농장과 함께라면 독서가 더욱 즐거워집니다! 함께 독서의 즐거움을 나눠보세요.
...
| <img src="https://img.shields.io/badge/tailwind CSS-06B6D4?style=flat&logo=tailwindCSS&logoColor=white"/>           | CSS 스타일링                   |
| <img src="https://img.shields.io/badge/React Icons-E7157B?style=flat&logo=ReactIcons&logoColor=white"/>            | 아이콘 라이브러리                |
| <img src="https://img.shields.io/badge/DaisyUI-5A0EF8?style=flat&logo=DaisyUI&logoColor=white"/>                    | 디자인 컴포넌트                 |
| <img src="https://img.shields.io/badge/React Query-FF4154?style=flat&logo=ReactQuery&logoColor=white"/>            | 서버 데이터 관리                 |
| <img src="https://img.shields.io/badge/Kakao-FFCD00?style=flat&logo=Kakao&logoColor=white"/>                        | 책 검색 API                    |
| <img src="https://img.shields.io/badge/MSW-E37400?style=flat&logo=MSW&logoColor=white"/>                            | Mock 데이터 연결                |
| <img src="https://img.shields.io/badge/Yarn-2C8EBB?style=flat&logo=Yarn&logoColor=white"/>                          | 패키지 매니저                   |
| <img src="https://img.shields.io/badge/Vite-646CFF?style=flat&logo=Vite&logoColor=white"/>                          | 빌드 툴                        |
<br />
...
* 프로젝트 기간
  ...
  * [24.04.04] 2일차 : 서비스 구체화를 위한 지도 그리기
  * [24.04.05] 3일차 : 개인별 스케치 및 기획 정리
  * [24.04.06 ~ 24.04.07] 4~5일차 : 개발 기간
  * [24.04.08] 6일차 : 데모데이(서비스 피드백)

 
* 개발 인원
  
    | <img src="https://avatars.githubusercontent.com/u/124887974?v=4" width="200" height="200" /> | <img src="https://avatars.githubusercontent.com/u/17701725?v=4" width="200" height="200" />  |
    | :------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------: |
    |                                          summermong(썸머)                                     |                                        Henry-Hong(앙리)                                       |
    |                                           Frontend                                           |                                           Frontend                                           |

    | <img src="https://avatars.githubusercontent.com/u/86069422?v=4" width="200" height="200" />  | <img src="https://avatars.githubusercontent.com/u/98196225?v=4" width="200" height="200" /> |
    | :------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------: |
    |                                           yeojincho(둥둥)                                     |                                        suneunkin(마루)                                        |
    |                                           Frontend                                           |                                           Frontend                                           |

    | <img src="https://avatars.githubusercontent.com/u/104331470?v=4" width="200" height="200" /> | <img src="https://avatars.githubusercontent.com/u/68915715?v=4" width="200" height="200" /> |
    | :------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------: |
    |                                       ninnistic(니니)                                         |                                        Lee-Hyoyeon(쿼카)                                      |
    |                                           Frontend                                           |                                           Frontend                                           |
  
    | <img src="https://avatars.githubusercontent.com/u/49530253?v=4" width="200" height="200" />  |
    | :------------------------------------------------------------------------------------------: |
    |                                         tmddus2(미아)                                         |
    |                                         Backend                                              |
